...
|---|---|---|
| [`artifacts/symlink-to-rce/`](artifacts/symlink-to-rce/) | Deceptive shell file copies combined with pre-committed symbolic links silently overwrite configurations to achieve unsandboxed RCE upon assistant restart. Confirmed across Claude Code, Gemini CLI, Cursor Agent CLI, GitHub Copilot CLI, Grok Build CLI, and Codex Agent. | [SymJack: the approval prompt is lying to you. A symlink-hijack RCE in six AI coding agents](https://adversa.ai/blog/the-approval-prompt-is-lying-to-you-symlink-rce-in-five-ai-coding-agents-claude-code-cursor-antigravity-copilot-grok-build/) |
